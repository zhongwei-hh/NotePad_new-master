...
public class NotesList extends ListActivity {
    ...
    private static final String[] PROJECTION = new String[] {
            ...
            NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE,//加入修该时间
            NotePad.Notes.COLUMN_NAME_TODO_STATUS,//加入待办状态
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            if (!isInBatchMode) {
                ...
                view.findViewById(R.id.select_checkbox).setVisibility(View.VISIBLE);
                ((CheckBox) view.findViewById(R.id.select_checkbox)).setChecked(true);
            }
            return true;
        });
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                ...
                Log.d("NotesList", "Title Index: " + titleIndex + ", Title: " + title);
                ...
                // 添加类型转换
                CheckBox todoCheckBox = (CheckBox) view.findViewById(R.id.todo_checkbox);
                //批量删除
                ...
                todoCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                    ...
                    values.put(NotePad.Notes.COLUMN_NAME_TODO_STATUS, isChecked ? 1 : 0);
